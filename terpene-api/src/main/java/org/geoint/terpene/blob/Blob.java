...
import org.geoint.terpene.security.lbac.LabeledString;
import org.geoint.terpene.security.malware.MalwareScanResult;
...
public interface Blob {
    ...
    /**
     * Return the latest virus scan result, if available.
     *
     * @return current virus scan results for the blob
     *
     */
    Optional<MalwareScanResult> getVirusScanResult();
